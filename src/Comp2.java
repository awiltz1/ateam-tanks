...
public class Comp2 extends Player
{
	private ArrayList<Obstacle> objects;
	private SimpleTank opponent;
	private OrderQueue orders;
	private int frames;
	public Comp2(ArrayList<Obstacle> objects, ArrayList<SimpleTank> tanks, SimpleTank enemy, Color c) {
	...
	public Vector3D newPos(Obstacle o) {
		return new Vector3D();
	}
	public Vector3D getPos() {
		...
		while (b == false) {
			dist += 50;
			newPos = new Vector3D( new Vector3D(dist, new Direction(angle-180)),oppPos);
